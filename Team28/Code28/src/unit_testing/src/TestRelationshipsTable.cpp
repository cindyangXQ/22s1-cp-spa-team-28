...
TEST_CASE("ParentTable can store multiple Rights to the same Left and retrieve correctly") {
...
TEST_CASE("ParentTTable can store multiple Lefts to the same Right and retrieve correctly") {
...
TEST_CASE("FollowsTable can initialise, store and retrieve correctly") {
	...
	// Follows (2, 5)
	Relationship<int, int> test2 = Relationship(RelationshipReference::FOLLOWS, 2, 5);
...
TEST_CASE("FollowsTTable can initialise, store and retrieve correctly") {
	...
	Relationship<int, int> test2 = Relationship(RelationshipReference::FOLLOWS_T, 1, 3);
...
TEST_CASE("ModifiesSTable can store multiple Lefts to the same Right and retrieve correctly") {
	ModifiesSTable modifiesSTable;
...
TEST_CASE("UsesSTable can initialise, store and retrieve correctly") {
	...
	// Uses (3, "v")
	Relationship<int, std::string> test = Relationship(
		RelationshipReference::USES, 3, std::string("v")
	);
