...
TEST_CASE("ClauseTable can create new table from two input table") {
    ...
    REQUIRE(tableJoin.header[0].getSynonymName() == syn2.getName());
    REQUIRE(tableJoin.header[1].getSynonymName() == syn1.getName());
    REQUIRE(tableJoin.header[2].getSynonymName() == syn3.getName());
}
...
TEST_CASE("ClauseTable can join two tables with common headers") {
    ...
    REQUIRE(result.header[0].getSynonymName() == syn2.getName());
    REQUIRE(result.header[1].getSynonymName() == syn1.getName());
    REQUIRE(result.header[2].getSynonymName() == syn3.getName());
}
...
TEST_CASE("ClauseTable can join two tables with no common headers") {
    ...
    REQUIRE(result.header[0].getSynonymName() == syn1.getName());
    REQUIRE(result.header[1].getSynonymName() == syn2.getName());
    REQUIRE(result.header[2].getSynonymName() == syn3.getName());
    REQUIRE(result.header[3].getSynonymName() == syn4.getName());
}
